...
# lifetime infections
  tmp1 <- as.data.frame(sim_out[[j]][[1]]$lifetime_infections)
  n_sim <- dim(tmp1)[2]
  ...
  tmp2 <- as.data.frame(sim_out[[j]][[2]]$lifetime_infections)
  ...
  tmp3 <- as.data.frame(sim_out[[j]][[3]]$lifetime_infections)
